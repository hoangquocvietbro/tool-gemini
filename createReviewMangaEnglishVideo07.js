...
async function Run() {
  ...
  for (const url of urls) {
    ...
    try {
      ...
      try {
        try {
          await extractImageAndMakeMp3VN(rootFolder, index, videoID);
        } catch {
          await extractImageAndMakeMp3VN(rootFolder, index, videoID);
        }
      } catch {
        ...
        try {
          ...
          await extractImageAndMcreateVideoFromImagesAndMp3FolderVNakeMp3VN(rootFolder, index, videoID);
        }
